...
estimator.options.resilience.zne.noise_factors = (1, 3, 5, 7)
...
np.savez('data/qiskit_circuit_energy_estimation_results_ZNE',energies=energies,errors=errors,hamiltonian_terms=hamiltonian_terms)
